...
We'd need to use a different emergent phenomenon that can quantify the main characteristic of these systems. I expect a good candidate would be local Kolmogorov complexity. A good read on this is [Scott Aarsonson's post titled "Quantifying the Rise and Fall of Complexity in Closed Systems: The Coffee Automaton"](https://scottaaronson.blog/?p=1818) where he explains how a state on the edge of chaos and order puts the system in a more dynamic, expressive state, which can be quantified by this metric. I successfully used this before in Cellular Automata research on [quantifying interestingness in images](/blog/quantifying-interestingness-images-information-theory).
...
I will likely try to code the hierarchical BOIDS example in the near future, so stay tuned for that. The closest I've come so far is [putting neural cellular automata into a flock of boids](/blog/neural-cellular-automata-swarming), and later [Microcosmos](/blog/microcosmos-differentiable-artificial-life), which actually evolves its agents. I also sharpened what I mean by emergence here in [emergence vs 'unexpected' emergence in artificial life](/blog/unexpected-emergence-in-artificial-life).
...
If you happen to use this model somewhere, please cite:
  ...
  https://marktension.nl/blog/hierarchical-boids-game-of-life-and-consciousness
