...
const GenerativePortfolio = props => {
  ...
  return (
    <div id="generative" style={{ marginTop: "2%", paddingLeft: "5%", alignContent: "right" }} >
      ...
      >
        <Box p={[0]} m={[0]} width={[1, 1 / 2]} style={releaseStylesheet}>
          <img src={require("../images/" + jsonData[0].image1).default} className="label-logo" alt="schmoo" />
        </Box>
        <Box p={[0]} m={[0]} width={[1, 1 / 2]} style={releaseStylesheet}>
          <img src={require("../images/" + jsonData[0].image2).default} className="label-logo" alt="schmoo" />

        </Box>
        <Image src={require("../images/" + jsonData[0].image1).default}  p={[0]} m={[0]} width={[1, 1 / 2]} style={releaseStylesheet} />
        <Image src={require("../images/" + jsonData[0].image1).default}  p={[0]} m={[0]} width={[1, 1 / 2]} style={releaseStylesheet} />
