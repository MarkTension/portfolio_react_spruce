...
function ImageMobile() {
  ...
  if (isBrowser) {
    return <img style={{"object-fit": cover}} src={phaseGraph} width="60vw" style={{marginRight:"5%", objectFit: "cover"}} className="label-logo" alt="logo"/>
  }
  else{
    return <img src={phaseGraph} width="60vw"  className="label-logo" alt="logo"/>
  }
}
