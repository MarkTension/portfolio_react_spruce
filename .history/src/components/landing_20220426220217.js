    ...
    return (
        <div id="landing" style = {{marginTop:"2%",alignContent:"right"}} >
            ...
            <Item style={{width:"90%",textAlign:"right",fontSize:"0.9em"}}>
              ...
              <Item style={{width:"90%",textAlign:"right",fontSize:"0.9em"}}>
              <a href="https://twitter.com/Mark_Tension">I share things on twitter</a>.               For my music, please visit <a href="https://open.spotify.com/artist/1lB15Q7MjR8s2j7TzeMP9Y?si=Z8aIfkyyT4qpf1HxKi2TdA&dl_branch=1">Spotify</a>.
