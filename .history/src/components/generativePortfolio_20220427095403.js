  ...
  var itemOne = jsonData[0]
    ...
    return (
        <div id="generative" style = {{marginTop:"2%", paddingLeft:"5%",alignContent:"right"}} >
            <Title>
            Generative Projects {JSON.stringify(jsonData[0])}
           </Title>  
           ...
           <Item style={{width:"90%",textAlign:"center",fontSize:"0.9em"}}>
            ...
            <img src={require("../images/" + jsonData[0].image1).default} style={{marginRight:"5%",width:"30vw",height:"30vw"}} className="label-logo" alt="schmoo"/>
            ...
            >
                ...
                <Image src={require("../images/" + jsonData[0].image1).default} p={[1]} m={[0]} width={[1, 1 / 2]} style={releaseStylesheet} />
