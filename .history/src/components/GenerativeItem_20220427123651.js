            ...
            >
                ...
                {typeof props.content.image3 != "undefined" ?
                    ...
                    : <Box p={[1]} m={[0]} width={[1,1]} style={releaseStylesheet}>
                        <Image src={require("../images/" + props.content.image1)} p={[0]} m={[0]} width={[1, 1 / 4]} style={imageStylesheet} />
                        <Image src={require("../images/" + props.content.image2)} p={[0]} m={[0]} width={[1, 1 / 4]} style={imageStylesheet} />
