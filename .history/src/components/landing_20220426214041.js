    ...
    return (
        <div id="landing" style = {{marginTop:"2%",alignContent:"right"}} >
            ...
            <Item style={{width:"90%",textAlign:"right",fontSize:"0.9em"}}>
              ...
              <Item style={{width:"90%",textAlign:"right",fontSize:"0.9em"}}>
              You'll find Machine Learning, Music, photography, and generative design.
              </Item>

              <Item style={{width:"90%",textAlign:"right",fontSize:"0.9em"}}>
              Always looking for ways to collaborate! <a href="mailto:tensen.mark@gmail.com">Shoot me an email</a>.
              </Item>
