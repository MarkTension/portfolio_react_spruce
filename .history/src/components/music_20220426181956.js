...
import { Button, Item, Title } from "./textConstants";
...
var imArray = [tensenIm, springwalk]
var counter = 0
...
class Music extends React.Component {
  ...
  ProcessClick(event){
    ...
    var image = imDict[id]
    this.setState({showNames: false, image: image})
    ...
    return (
      <div id="music" style = {{height:"100vh"}}>
        <section  style={{backgroundColor:"white",height:"100vh",marginLeft:"0%", marginTop:"0%",backgroundSize: "100%"}}>
          ...
          <Item style={{fontSize: "1.2em",textAlign:"left",margin:"5%"}}>
            I'm experimenting with ambient music. through balance and chaos and using computational/ai methods + old analog tape equipment, I want to create some _alive_ sounds. 
          </Item>
          
          <SpotifyPlayer
                  uri="https://open.spotify.com/playlist/2LRfRHlLHKHAQWiaIzxStJ?si=3214cd24929c4a91"
                  size={{
                      width: '50%',
                      height: 300,
                    }}
