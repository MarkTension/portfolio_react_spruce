...
function ImageMobile() {
  ...
  if (isBrowser) {
    return <img src={phaseGraph} width="70%" style={{ marginRight: "5%", objectFit: "contain" }} className="label-logo" alt="logo" />
  }
  else {
    return <img src={phaseGraph} width="70%" style={{ marginRight: "5%", objectFit: "contain" }} className="label-logo" alt="logo" />
  }
...
const Landing = props => {
  return (
    <div id="landing" style={{ marginTop: "2%", alignContent: "right" , background: "black"}} >
