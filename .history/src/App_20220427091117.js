  ...
  return (    
    <div className="App" >
      <header className="App-header" width="100%" >
        <div id="home" width="100%" style={{marginLeft: isBrowser ? "15%" : "0%" ,marginRight:"0%",padding:"0%", alignContent:"left"}}>
          <div id="schmoooo" style={{height:"100vh", width:"85vw", background: "black", paddingTop:"0%", marginTop:"0%"}}>
